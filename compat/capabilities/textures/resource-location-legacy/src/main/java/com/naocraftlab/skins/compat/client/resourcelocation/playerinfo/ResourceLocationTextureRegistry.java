...
public final class ResourceLocationTextureRegistry
        extends AbstractTextureRegistry<ResourceLocationTextureRegistry.NativeTexture> {
    ...
    public ResourceLocationTextureRegistry() {
        this("preview", () -> { });
    }

    ResourceLocationTextureRegistry(String pathRoot) {
        this(pathRoot, () -> { });
    }

    ResourceLocationTextureRegistry(String pathRoot, Runnable lifecycleTransition) {
    ...
    public String toString() {
        return "ResourceLocationTextureRegistry[closed=" + isClosed()
