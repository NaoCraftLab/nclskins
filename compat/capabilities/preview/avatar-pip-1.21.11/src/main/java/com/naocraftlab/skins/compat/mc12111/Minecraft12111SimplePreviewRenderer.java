...
public final class Minecraft12111SimplePreviewRenderer
    ...
    private final Minecraft12111BakedPreviewTarget target =
            new Minecraft12111BakedPreviewTarget();
    ...
    public void render(GuiGraphics graphics, PreviewRequest request) {
        ...
        Minecraft12111BakedPreviewRenderState state = new Minecraft12111BakedPreviewRenderState(
                target,
                model,
    ...
    private static void submit(
            ...
            int bottom,
            Minecraft12111BakedPreviewRenderState state) {
        try (Minecraft12111BakedPreviewSubmission submission =
                Minecraft12111BakedPreviewSubmission.open(graphics, state)) {
