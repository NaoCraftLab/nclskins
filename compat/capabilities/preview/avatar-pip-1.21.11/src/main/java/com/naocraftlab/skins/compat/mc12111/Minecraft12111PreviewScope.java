...
public final class Minecraft12111PreviewScope implements AutoCloseable {
    private static final ThreadLocal<Minecraft12111PreviewScope> ACTIVE = new ThreadLocal<>();
    ...
    private Minecraft12111PreviewScope(
    ...
    public static Minecraft12111PreviewScope open(
            Minecraft minecraft,
            AbstractClientPlayer player,
            PreviewRenderer.PreviewAppearance appearance,
            PlayerSkin skin,
        ...
        Minecraft12111PreviewScope scope = new Minecraft12111PreviewScope(
    ...
    public static ItemStack equipment(
        ...
        Minecraft12111PreviewScope scope = current(entity);
        if (scope == null) {
            return original;
        }
    ...
    private static Minecraft12111PreviewScope current(Object candidate) {
        Minecraft12111PreviewScope scope = ACTIVE.get();
