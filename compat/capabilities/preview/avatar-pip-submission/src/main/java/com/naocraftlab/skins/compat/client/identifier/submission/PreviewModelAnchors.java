...
public final class PreviewModelAnchors implements AutoCloseable {
    private static final ThreadLocal<PreviewModelAnchors> ACTIVE =
            new ThreadLocal<>();
