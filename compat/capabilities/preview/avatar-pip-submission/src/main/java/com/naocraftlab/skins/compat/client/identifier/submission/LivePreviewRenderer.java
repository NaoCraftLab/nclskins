...
public final class LivePreviewRenderer
        extends PictureInPictureRenderer<LivePreviewRenderState> {
    public LivePreviewRenderer(MultiBufferSource.BufferSource bufferSource) {
        super(bufferSource);
    }

    @Override
    public Class<LivePreviewRenderState> getRenderStateClass() {
        return LivePreviewRenderState.class;
    }
    ...
    @Override
    protected void renderToTexture(LivePreviewRenderState state, PoseStack pose) {
        Minecraft minecraft = Minecraft.getInstance();
        try (PreviewScope ignoredContext =
            ...
            SubmissionPreviewRenderer.PreviewPlayer renderPlayer = state.previewPlayer();
            ...
            SubmissionPreviewRenderer.configure(avatarState, state.request());
