...
public final class AvatarPreviewScope implements AutoCloseable {
    private static final ThreadLocal<AvatarPreviewScope> ACTIVE = new ThreadLocal<>();
    ...
    public static AvatarPreviewScope open(
            Minecraft minecraft,
            AbstractClientPlayer player,
            PreviewRenderer.PreviewAppearance appearance,
            PlayerSkin skin,
        ...
        AvatarPreviewScope scope = new AvatarPreviewScope(
    ...
    public static ItemStack equipment(LivingEntity entity, EquipmentSlot slot, ItemStack original) {
        AvatarPreviewScope scope = current(entity);
        if (scope == null) {
            return original;
        }
    ...
    private static AvatarPreviewScope current(Object candidate) {
        AvatarPreviewScope scope = ACTIVE.get();
