...
abstract class AvatarRenderStateMixin implements NclSkinsWideDepthState {
    ...
    @Unique
    private Identifier nclskins$worldlessCapeTexture;
    ...
    @Override
    public Identifier nclskins$worldlessCapeTexture() {
        return nclskins$worldlessCapeTexture;
    }

    @Override
    public void nclskins$setWorldlessCapeTexture(Identifier texture) {
        nclskins$worldlessCapeTexture = texture;
    }
}
