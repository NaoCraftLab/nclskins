...
public final class Minecraft262PreviewScope implements AutoCloseable {
    private static final ThreadLocal<Minecraft262PreviewScope> ACTIVE = new ThreadLocal<>();
    ...
    private Minecraft262PreviewScope(
    ...
    public static Minecraft262PreviewScope open(
            Minecraft minecraft,
            AbstractClientPlayer player,
            PreviewRenderer.PreviewAppearance appearance,
            PlayerSkin skin,
        ...
        Minecraft262PreviewScope scope = new Minecraft262PreviewScope(
    ...
    public static ItemStack equipment(LivingEntity entity, EquipmentSlot slot, ItemStack original) {
        Minecraft262PreviewScope scope = current(entity);
        if (scope == null) {
            return original;
        }
    ...
    private static Minecraft262PreviewScope current(Object candidate) {
        Minecraft262PreviewScope scope = ACTIVE.get();
