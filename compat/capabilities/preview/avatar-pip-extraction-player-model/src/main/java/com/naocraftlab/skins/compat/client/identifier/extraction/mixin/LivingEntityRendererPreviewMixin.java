...
import com.naocraftlab.skins.compat.client.identifier.extraction.PreviewModelAnchors;
...
abstract class LivingEntityRendererPreviewMixin {
    ...
    private void nclskins$isolateEditorLayer(
        ...
        if (!(state instanceof AvatarRenderState)) {
            original.call(layer, poseStack, collector, light, state, yRot, xRot);
            return;
        }
        AvatarRenderState avatarState = (AvatarRenderState) state;
        boolean slim = avatarState.skin != null
