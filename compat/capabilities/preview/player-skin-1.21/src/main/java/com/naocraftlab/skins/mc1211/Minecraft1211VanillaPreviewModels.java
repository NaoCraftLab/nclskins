...
final class Minecraft1211VanillaPreviewModels {
    private static final Minecraft1211VanillaPreviewModels INSTANCE =
            new Minecraft1211VanillaPreviewModels();
    ...
    private Minecraft1211VanillaPreviewModels() {
    ...
    static Minecraft1211VanillaPreviewModels instance() {
        return INSTANCE;
    }
