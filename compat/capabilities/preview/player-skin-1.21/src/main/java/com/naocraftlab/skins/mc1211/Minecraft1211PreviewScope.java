...
public final class Minecraft1211PreviewScope implements AutoCloseable {
    private static final ThreadLocal<Minecraft1211PreviewScope> ACTIVE = new ThreadLocal<>();
    ...
    private Minecraft1211PreviewScope(
    ...
    public static Minecraft1211PreviewScope open(
            Minecraft minecraft,
            AbstractClientPlayer player,
            PreviewRenderer.PreviewAppearance appearance) {
        ...
        Minecraft1211PreviewScope scope = new Minecraft1211PreviewScope(player, appearance);
        ACTIVE.set(scope);
        return scope;
    }

    public static PlayerSkin skin(AbstractClientPlayer player, PlayerSkin original) {
        Minecraft1211PreviewScope scope = current(player);
    ...
    public static ItemStack equipment(LivingEntity entity, EquipmentSlot slot, ItemStack original) {
        Minecraft1211PreviewScope scope = current(entity);
        if (scope == null) {
            return original;
        }
    ...
    private static Minecraft1211PreviewScope current(Object candidate) {
        Minecraft1211PreviewScope scope = ACTIVE.get();
