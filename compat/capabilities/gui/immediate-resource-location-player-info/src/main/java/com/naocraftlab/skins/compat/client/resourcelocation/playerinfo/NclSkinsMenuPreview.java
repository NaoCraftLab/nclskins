...
import com.naocraftlab.skins.compat.client.resourcelocation.playerinfo.mixin.ScreenRenderablesAccessor;
...
public final class NclSkinsMenuPreview implements Renderable, LayoutElement {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        SimplePreviewRenderer renderer = previewState.rendererWhenReady();
        if (renderer == null) {
            return;
        }
    ...
    private static final class PreviewState {
        private SimplePreviewRenderer renderer;

        private SimplePreviewRenderer rendererWhenReady() {
            if (renderer != null) {
                return renderer;
            }
            try {
                renderer = new SimplePreviewRenderer();
