...
import com.naocraftlab.skins.compat.v1_20_1.client.Minecraft1201PreviewModelAnchors;
...
abstract class LivingEntityRendererPreviewMixin {
    ...
    private void nclskins$isolateEditorLayer(
        ...
        try (Minecraft1201PreviewModelAnchors ignored = Minecraft1201PreviewModelAnchors.open(model)) {
            layer.render(
                    poseStack,
                    buffers,
                    light,
